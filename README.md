...
5. В настройках расширения импортировать локаторы из файла `mistension_locators.json`
6. Если не срабатывает (не меняет свой вид курсор) hotkeys по-умолчанию - Ctrl-Shift-F, то установить нужные горячие клавиши для включения режима редактирования в `Управление расширениями - Быстрые клавиши - Mistension - Автозаполнение`
